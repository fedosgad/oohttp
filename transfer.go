...
// addHeaders adds transfer headers to an existing header object so they can be sorted
...
// writeHeader is currently only used on server side, where no header sorting is performed
